...
var textoPerder;
var MickyBarLayer = cc.Layer.extend({
    spriteFondo:null,
    ...
    ctor:function () {
        ...
        cc.loader.loadJson(res.textos_micky_fase2 ,function(error, data){
            texto = data;
        });
...
var MickySceneBar = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new MickyBarLayer();
        this.addChild(layer);
    }
});