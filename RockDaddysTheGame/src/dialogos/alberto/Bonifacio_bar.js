...
var textoPerder;
var BonifacioBarLayer = cc.Layer.extend({
    spriteFondo:null,
    ...
    ctor:function () {
        ...
        //Micky
        this.spriteMicky = cc.Sprite.create(res.alberto_png);
        ...
        //Texto
        this.labelTexto = cc.LabelTTF.create('label text',  'Arial', 15, cc.size(430,100), cc.TEXT_ALIGNMENT_LEFT);
        this.labelTexto.x = 400;
        this.labelTexto.y = 80;
        this.addChild(this.labelTexto, 5);

        //Opcion1
        this.labelOpcion1 = cc.LabelTTF.create('label text',  'Arial', 15, cc.size(500,30), cc.TEXT_ALIGNMENT_LEFT);
        this.labelOpcion1.x = 470;
        this.labelOpcion1.y = 65;
        this.addChild(this.labelOpcion1, 5);
        //Opcion2
        this.labelOpcion2 = cc.LabelTTF.create('label text',  'Arial', 15, cc.size(500,30), cc.TEXT_ALIGNMENT_LEFT);
        ...
        cc.loader.loadJson(res.textos_alberto_fase2 ,function(error, data){
            texto = data;
        });
...
var BonifacioSceneBar = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new BonifacioBarLayer();
        this.addChild(layer);
    }
});