...
var textoPerder;
var KuzcoBarLayer = cc.Layer.extend({
    spriteFondo:null,
    ...
    ctor:function () {
        ...
        cc.loader.loadJson(res.textos_kuzco_fase2 ,function(error, data){
            texto = data;
        });
...
var KuzcoSceneBar = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new KuzcoBarLayer();
        this.addChild(layer);
    }
});