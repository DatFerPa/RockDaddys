...
var textoPerder;
var RicardoWinLayer = cc.Layer.extend({
    spriteFondo:null,
    ...
    ctor:function () {
        ...
        //Fondo
        this.spriteFondo = cc.Sprite.create(res.mapa_ricardo_png);
       ...
       cc.director.runScene(new AventuraGraficaSceneRicardo());

    },launchMinijuego:function(){
        console.log("STEVEN!");
        this.minijuego = false;
        auxTextPosition = this.posDialogo;
       cc.director.runScene(new RecolectorMonedasScene());
    }
